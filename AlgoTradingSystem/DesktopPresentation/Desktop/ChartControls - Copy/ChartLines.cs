        ...
        protected override void OnRender(DrawingContext drawingContext)
        {
            ...
            if (HorizontalAxisTickPositions != null)
            {
                if (DrawHorizontalAxisReferenceLines)
                {
                    ...
                    {
                        if ( (HorizontalAxisTickPositions.Count>100 && i%30==0) ||  HorizontalAxisTickPositions.Count <100)
                            drawingContext.DrawLine(new Pen(Brushes.Gray, 0.5), new Point(HorizontalAxisTickPositions[i], 0), new Point(HorizontalAxisTickPositions[i], RenderSize.Height));
                ...
                else if (DrawHorizontalAxisTickMarks)
                {
                    ...
                    {
                        if ((HorizontalAxisTickPositions.Count > 100 && i % 30 == 0) || HorizontalAxisTickPositions.Count < 100)
                            drawingContext.DrawLine(new Pen(Brushes.Gray, 0.5), new Point(HorizontalAxisTickPositions[i], HorizontalAxis - TickMarksLength / 2), new Point(HorizontalAxisTickPositions[i], HorizontalAxis + TickMarksLength / 2));
